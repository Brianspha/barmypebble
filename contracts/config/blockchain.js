...
module.exports = {
  ...
  hedera: {
    rpcPort:"50211",
    networkId:"0",
    endpoint:"https://0.testnet.hedera.com",
    networkType: "custom", // Can be: testnet(ropsten), rinkeby, livenet or custom, in which case, it will use the specified networkId
    syncMode: "light",
    accounts: [
      {
        nodeAccounts: true,
