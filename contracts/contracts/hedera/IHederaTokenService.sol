...
interface IHederaTokenService {
    ...
    function transferTokens(address token, address[] calldata accountId, int64[] calldata amount) external
    ...
    function transferNFTs(address token, address[] calldata sender, address[] calldata receiver, int64[] calldata serialNumber)
