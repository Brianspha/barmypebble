  ...
  computed: {
    headers() {
      return [
        ...
        { text: "IONFTS Minted", value: "barmypebbles_minted" },
      ];
    },
  },
  mounted() {
  ...
  methods: {
    ...
    init: async function() {
      ...
      if (data.leaderboard.length > 0) {
        ...
        this.data.users = data.leaderboard.sort(
          (a, b) => parseInt(a.barmypebbles_minted) - parseInt(b.barmypebbles_minted)
        );
        var i = 0;
        this.data.users.map((user) => {
          this.leaderboard.push({
            ...
            barmypebbles_minted: user.barmypebbles_minted,
          });
        });
      }
